...
public class ArtistCell extends VBox {
    ...
    private void init(Artist artist, StackPane content) {
        ...
        header.setStyle("-fx-background-color: " + getRandomtColor());
        ...
        body.setStyle("-fx-background-color: " + getRandomtColor());
        ...
        button.setStyle("-fx-background-radius: 50%; -fx-background-color: " + getRandomtColor());
    ...
    private String getRandomtColor() {
